...
def train_random_forest(dataset_path):
    ...
    rf_classifier = RandomForestClassifier(n_estimators=100, random_state=42)  # Puoi cambiare n_estimators
    ...
    print("\nRisultati sul Training con Random Forest:")
    ...
    print("\nRisultati sul Test con Random Forest:")
